...
for j in range(len(K)):
    imv1.append(bsm_call_imp_vol(S0, K[j], T[0], r[0], C1[j], 0.2))
    imv2.append(bsm_call_imp_vol(S0, K[j], T[1], r[1], C2[j], 0.2))
    imv3.append(bsm_call_imp_vol(S0, K[j], T[2], r[2], C3[j], 0.2))
    imv4.append(bsm_call_imp_vol(S0, K[j], T[3], r[3], C4[j], 0.2))
    imv5.append(bsm_call_imp_vol(S0, K[j], T[4], r[4], C5[j], 0.2))
imv1 = array(imv1)
imv2 = array(imv2)
imv3 = array(imv3)
imv4 = array(imv4)
