...
#
# 10_mcs/SVSI_american_mcs_10_4.py
#
...
m_list = [20]  # number of time intervals
...
x_disc_list = ['Full Truncation', 'Partial Truncation', 'Truncation',
               'Absorption']  # , 'Reflection', 'Higham-Mao',
                                # 'Simple Reflection']
...
if write:
    ...
    h5 = pd.HDFStore('10_mcs/mcs_american_%s.h5' % d, 'w')
    h5['results'] = results
    h5.close()
